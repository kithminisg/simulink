...
function update() {
    ! curl "https://raw.githubusercontent.com/$repo_owner/$repo_name/updated-patch-kith/sashimono/patches/resources/reputationd/$file" -o "$download" && echo "Download failed!" && return 1
