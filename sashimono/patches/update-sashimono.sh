...
if (! curl "https://raw.githubusercontent.com/$repo_owner/$repo_name/updated-patch-kith/sashimono/patches/resources/sashimono/$file" -o "$SASHIMONO_BIN/$file") || (! chmod +x "$SASHIMONO_BIN/$file"); then
